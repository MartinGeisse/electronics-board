...
public final class OrGate extends Component {

    private final Net net1;
    private final Net net2;
    private final Driver driver;

    public OrGate(ItemBasedSimulationModel simulationModel, String boardObjectId, Net net1, Net net2, Net outputNet) {
    ...
    public void onNetValueChanged(Net net, LogicValue oldValue, LogicValue newValue) {
        driver.setValueAfter(net1.getValue().or(net2.getValue()), GateConstants.STANDARD_GATE_DELAY_TICKS);
    }
