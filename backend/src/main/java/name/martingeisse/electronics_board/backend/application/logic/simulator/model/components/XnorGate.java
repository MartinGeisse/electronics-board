...
public final class XnorGate extends Component {

    private final Net net1;
    private final Net net2;
    private final Driver driver;

    public XnorGate(ItemBasedSimulationModel simulationModel, String boardObjectId, Net net1, Net net2, Net outputNet) {
    ...
    public void onNetValueChanged(Net net, LogicValue oldValue, LogicValue newValue) {
        driver.setValueAfter(net1.getValue().xnor(net2.getValue()), GateConstants.STANDARD_GATE_DELAY_TICKS);
    }
